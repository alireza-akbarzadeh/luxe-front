...
name: framer-motion
description: >
  Use for luxe-front storefront/marketing animations with motion/react — hero stagger,
  page transitions, drawer slide-ins. Animate transform and opacity only; avoid width/height.
  Do not use for admin perf (luxe-react-performance), DataTable, or useAppForm flows.
---
