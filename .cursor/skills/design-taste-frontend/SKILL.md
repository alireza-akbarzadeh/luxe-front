...
description: >
  Use for landing pages, portfolios, and marketing redesigns that look templated or AI-generated.
  Audit-first, brief inference, anti-slop patterns. Do not use for admin dashboards, DataTable,
  multi-step product UI, or backend/API work.
---
