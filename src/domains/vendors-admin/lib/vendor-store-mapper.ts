import type { VendorStoreFormValues } from '@/domains/vendors-admin/schemas/vendor-store.schema';
import type { DtoStoreResponse } from '@/services/-admin-stores-{id}-get.schemas';
...
export function mapFormToCreateStoreRequest(values: VendorStoreFormValues): DtoCreateStoreRequest {
  return {
...
export function mapFormToUpdateStoreRequest(values: VendorStoreFormValues): DtoUpdateStoreRequest {
...
export function mapStoreToFormValues(store: DtoStoreResponse): VendorStoreFormValues {
  return {
    name: store.name ?? '',
