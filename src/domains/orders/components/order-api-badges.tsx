...
const ORDER_STATUS_STYLES: Record<string, string> = {
  ...
  delayed: 'bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-950/40 dark:text-orange-400',
...
function StatusBadge({ status, styles, size = 'sm' }: BadgeProps & { styles: Record<string, string> }) {
