...
/** Scrollable cart breakdown for the mobile snap drawer. */
export function CartMobileSummaryBody({
  onNavigate,
  showItems = true,
  showTotals = true
}: CartMobileSummaryBodyProps) {
    ...
    <div className='pb-2'>
      ...
      {showTotals ? (
        <Flex
          direction='column'
          gap={2.5}
          className={cn('bg-muted/40 rounded-2xl p-4', showItems ? 'mt-4' : 'mt-2')}
        >
