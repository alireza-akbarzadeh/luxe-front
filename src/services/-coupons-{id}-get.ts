...
import type { DtoCouponSingleResponse, UtilsResponse } from './-coupons-{id}-get.schemas';
...
>(
  id: number,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getCouponsId>>, TError, TData>>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getCouponsId>>> = ({ signal }) =>
