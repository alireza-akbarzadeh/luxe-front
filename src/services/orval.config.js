module.exports = [
  ...
  {
    "output": {
      "target": "/Users/alirezaakbarzadeh/workshop/github.com/alireza-akbarzadeh/src/luxe-front/src/services/-categories-post.ts",
      "client": "react-query",
      "httpClient": "axios",
      "mode": "split",
      "prettier": true,
            ...
            "post": {
              ...
              "requestBody": {
                "content": {
                  "application/json": {
                    "schema": {
                      "$ref": "#/components/schemas/dto.CreateStoreReviewRequest"
                    }
                  }
                },
                "description": "Review data",
            ...
            "put": {
              ...
              "requestBody": {
                "content": {
                  "application/json": {
                    "schema": {
                      "$ref": "#/components/schemas/dto.UpdateStoreReviewRequest"
                    }
                  }
                },
