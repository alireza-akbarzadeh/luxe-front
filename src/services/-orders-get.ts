...
import type { GetOrders200, GetOrdersParams, UtilsResponse } from './-orders-get.schemas';
...
export const getOrders = (
  ...
  return customInstance<GetOrders200>({ url: `/orders`, method: 'GET', params, signal }, options);
};
