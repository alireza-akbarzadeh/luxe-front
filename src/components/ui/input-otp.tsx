...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        'border-input bg-background dark:bg-input/30 relative flex size-12 items-center justify-center rounded-xl border text-base font-medium shadow-xs transition-all outline-none sm:size-14 sm:text-lg',
