...
export function AdminOrderNotFound() {
  const t = useTranslations('errors.admin.orderNotFound');
  ...
  return (
    <main className='relative flex min-h-[60vh] flex-1 items-center justify-center overflow-hidden px-4'>
      ...
      <motion.div
        aria-hidden
        className='pointer-events-none absolute -right-10 bottom-1/4 h-36 w-36 rounded-full bg-amber-200/20 blur-2xl'
